...
const Inicio = ({ onGoRegistro, onGoInicioUsuario }) => {
  ...
  useEffect(() => {
    const fetchUltimosLocales = async () => {
      try {
        const response = await fetch('https://api-savi.anima.edu.uy/api/empresas/ultimos');
        const data = await response.json();
        ...
        <div className="texto">
          ...
          <div className="quienes-grid">
            ...
            <div className="quienes-card">
              <h3>Valores</h3>
              <p>
                <strong><span className="valor-azul">Inclusión:</span></strong> participación para todos. 
                <strong><span className="valor-azul">Accesibilidad:</span></strong> eliminación de barreras. 
                <strong><span className="valor-azul">Innovación:</span></strong> tecnología para mejorar vidas. 
                <strong><span className="valor-azul">Responsabilidad social:</span></strong> compromiso empresarial con la accesibilidad. 
                <strong><span className="valor-azul">Transparencia:</span></strong> información clara y confiable.
              </p>
            </div>
            <div className="quienes-card">
              <h3>Colaboradores</h3>
